...
"use strict";
	...
	models.Orderline = models.Orderline.extend({
		...
		compute_all: function(taxes, price_unit, quantity, currency_rounding, handle_price_include=true, uom_id) {
			var self = this;
		...
		get_all_prices: function(){
				...
				var all_taxes = this.compute_all(product_taxes,
					price_unit, this.get_quantity(), this.pos.currency.rounding, true, this.get_unit());
				var all_taxes_before_discount = this.compute_all(product_taxes, this.get_unit_price(), this.get_quantity(), this.pos.currency.rounding, true, this.get_unit());
