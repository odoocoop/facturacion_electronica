        ...
        this.flush_mutex.exec(function(){
            ...
            transfer.pipe(function(order_server_id){
	                	...
	                	args: [fields]
											...
											var json_order = order_id.export_for_printing();
											json_order.sii_document_number = invoice_id.sii_document_number;
											json_order.nombre_documento = invoice_id.sii_document_class_id.name;
											var result =  {
												widget: this,
												pos: this.pos,
												order: order_id,
												receipt: json_order,
												orderlines: order_id.get_orderlines(),
											}
											var receipt = QWeb.render('XMLInvoice', result);
	                }, function(err_type, err){
	                	if (err.data.message) {
	                		self.gui.show_popup('error',{
	                			'title': _t('Error: Could not Get Invoice'),
