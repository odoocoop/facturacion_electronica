...
Se crea este repositorio, para dar un enfoque de firma electrónica directa con el SII.
 ...
 - - Factura de Exportación Electrónica ( 110 con sus NC 111 y ND 112): No Portado, faltan más Pruebas vía https://gitlab.com/dansanti/l10n_cl_dte_exportacion
 ...
 - - IVA
 - - Retención de IVA (Se necesita verificación Contabilidad de retención)
 - - Exentos
 - - Específico Retención Carnes
 - - Específico ILA cervezas
 - - Específico Combustibles (diesel, gasolina 93, gasolina 97)(parcialmente migrado a 14.0)
