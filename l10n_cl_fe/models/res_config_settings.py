...
class ResConfigSettings(models.TransientModel):
    ...
    url_remote_partners = fields.Char(related="company_id.url_remote_partners", string="Url Remote Partners", default="https://sre.cl/api/company_info")
    token_remote_partners = fields.Char(related="company_id.token_remote_partners", string="Token Remote Partners", default="token_publico",)
    sync_remote_partners = fields.Boolean(related="company_id.sync_remote_partners", string="Sync Remote Partners", default=True,)
    url_apicaf = fields.Char(related="company_id.url_apicaf", string="URL APICAF", default="https://apicaf.cl/api/caf",)
    token_apicaf = fields.Char(related="company_id.token_apicaf", string="Token APICAF", default="token_publico",)
