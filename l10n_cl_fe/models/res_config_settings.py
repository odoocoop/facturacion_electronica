...
class ResConfigSettings(models.TransientModel):
    ...
    dte_email_id = fields.Many2one("mail.alias", related="company_id.dte_email_id")
    limit_dte_lines = fields.Boolean(string="Limitar Cantidad de líneas por documento", default=False,)
    url_remote_partners = fields.Char(string="Url Remote Partners", default="https://sre.cl/api/company_info")
    token_remote_partners = fields.Char(string="Token Remote Partners", default="token_publico",)
    sync_remote_partners = fields.Boolean(string="Sync Remote Partners", default=True,)
    url_apicaf = fields.Char(string="URL APICAF", default="https://apicaf.cl/api/caf",)
    ...
    def get_values(self):
        ...
        partner_url_remote_partners = ICPSudo.get_param(
            "partner.url_remote_partners", default="https://sre.cl/api/company_info"
        )
        ...
        cf_autosend = ICPSudo.get_param("cf_extras.cf_autosend", default=False)
        res.update(
    ...
    def set_values(self):
        ...
        ICPSudo.set_param("cf_extras.cf_autosend", self.cf_autosend)
